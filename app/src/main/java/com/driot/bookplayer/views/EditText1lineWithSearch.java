...
public class EditText1lineWithSearch extends LoggingLinearLayout {
    ...
    public EditText1lineWithSearch(Context context) {
        super(context);
        init(context, null);
    }

    public EditText1lineWithSearch(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EditText1lineWithSearch(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    private void init(Context context, @Nullable AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.view_edittext_1line_search, this, true);
        ...
        // Enter/IME action can commit to history too
