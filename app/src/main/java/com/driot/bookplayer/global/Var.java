...
public class Var {
        ...
        public static final int RADIO_REFRESH_FOR_STATION_ACTIVITY_IN_MS = 300_000;
        public static final int RADIO_OG_IMAGE_TIMEOUT_MS = 5_000;
        ...
        public static final String SOURCE_LOCATION_RADIO_RECORDING = "radio_recording";
        ...
        public static final String PLAY_TYPE_RADIO = "radio";
        ...
        public static final HttpLoggingInterceptor.Level HTTP_LOGGING_INTERCEPTOR_LOG_LEVEL = BuildConfig.DEBUG
        ...
        public static final String DEFAULT_RADIO_MIRROR = "https://de1.api.radio-browser.info/"; // https://fi1.api.radio-browser.info";
                                                                                                 // //"https://radio.driot.com";

        // public static final int PODCAST_INDEX_ORG_SINCE_DEBUG = 1751716800 ; //5
        // juillet, 2025
        ...
        public static final Set<String> PATH_CHECK_AUDIO_FILE_INTERNAL = new HashSet<>(
                        Arrays.asList("com.driot.bookplayer/files/unzipped", "com.driot.bookplayerfull/files/unzipped",
                                        "com.driot.bookplayerpure/files/unzipped",
                                        "com.driot.bookplayer.debug/files/unzipped",
                                        "com.driot.bookplayerfull.debug/files/unzipped",
                                        "com.driot.bookplayerpure.debug/files/unzipped"));
        ...
        // Structured ebooks: need EbookSplitWorker to extract chapters (each file = one
        // book)
