...
public class ActivityBase
       extends com.driot.bookplayer.activities.LifecycleLoggingActivity {
    /**
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPermissionRequest = PermissionRequest
            ...
            .denied(R.string.permission_read_write_denied)
                 */
                .permissions(Manifest.permission.READ_EXTERNAL_STORAGE)
                .rationale(R.string.permission_read_rationale)
                .granted(R.string.permission_read_granted)
                .denied(R.string.permission_read_denied)
