...
public class PermissionRequest {
     ...
     */
    private com.driot.bookplayer.utils.PermissionRequest submit() {
        int showRationale = 0;
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public com.driot.bookplayer.utils.PermissionRequest submit() {
            ...
            return new com.driot.bookplayer.utils.PermissionRequest(this).submit();
        }
    }
}
