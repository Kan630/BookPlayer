...
public abstract class LoggingCoroutineWorker extends CoroutineWorker {

    protected final String TAG_FROM_BRACKET = "[" + getClass().getSimpleName() + "]: ";
    protected final String TAG_FROM = "." + getClass().getSimpleName();

    public LoggingCoroutineWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
